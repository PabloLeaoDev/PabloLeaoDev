...
- 👀 Interested in fullstack development (with a greater appreciation for the backend), reverse engineering, cybersecurity, low-level programming, and mathematics
- 🌱 Currently deepening my knowledge in JS/TS, PHP, and C
...
- 🎖️ **Ford `<Enter>` Program (SENAI CIMATEC)** — selected among 800+ candidates for an intensive front-end web development training
...
![Pablo's GitHub stats](https://github-readme-stats.vercel.app/api?username=PabloLeaoDev&show_icons=true&theme=default&hide_border=true)
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=PabloLeaoDev&layout=compact&hide_border=true)
